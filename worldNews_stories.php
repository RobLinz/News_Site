...
<html>
    ...
    <body class=homePage>
        ...
        <div id=news>
            <h2 class=ourStory>World News: </h2>
            <!--here we will display stories -->
            <?php
                require 'database_news.php';
                session_start(); 
                          
                $stmt = $mysqli->prepare("SELECT story_ID, title, story_description, story_link, category FROM stories where category='W'");
